...
Quando("clicar em my Addresses") do
  @cadastrarPage.myaddress_button.click
end

Quando("clicar em Add New adresse") do
  @cadastrarPage.addanew_button.click
end

Quando("preencher campos obrigatorios {string} {string} {string} {string} {string} {string} {string}") do |address1, city, state, zip_postal, home_phone, mobile_phone, please_assing|
  @cadastrarPage.address1.set address1
  @cadastrarPage.city. city
  @cadastrarPage.state.click
  @cadsstrarPage.zip_postal.set zip_postal
